    ...
    const handleOnClick = (tabName) => {
      ...
      <ul className="nav nav-pills flex-column mb-auto">
        <li className="nav-item" onClick={() => {
          ...
          <a  className = {`nav-link text-white ${selectedTab === 'Home'&& "active" } pointerClass`} aria-current="page">
        ...
        <li onClick={() => {
          ...
          <a  className = {`nav-link text-white ${selectedTab === 'CreatePost'&& "active" } pointerClass`} >
